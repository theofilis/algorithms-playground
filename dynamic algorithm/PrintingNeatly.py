...
def justification(words, page_width = 51):
	...
	def badness(line):
		...
		if total_length > page_width:
			...
			return (page_width - total_length) * 2
...
def expirement(text, page_width):
	words  = text.split()
...
if __name__ == '__main__' :
	...
	text = 'I wanted to smell that burnt midnight again, \
	I wanted to feel that wind. It was a secret wanting, \
	like a song I couldn\'t stop humming, or loving someone \
	I could never have.'

	example = 'blah blah blah blah reallylongword'

	expirement(example, 14)
